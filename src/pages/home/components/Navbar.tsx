...
export default function Navbar({ scrolled }: NavbarProps) {
  ...
  const DesktopDropdown = ({
    ...
    <div className="relative" onMouseEnter={() => handleMouseEnter(menuKey)} onMouseLeave={handleMouseLeave}>
      <button className="text-sm xl:text-base font-semibold transition-colors whitespace-nowrap cursor-pointer flex items-center text-[#1f3d67] hover:text-[#f5a000] gap-0.5 py-1">
        {label}
    ...
    >
      ...
      <nav className="hidden xl:block w-full px-4 bg-white border-t border-slate-100" style={{ overflow: 'visible' }}>
        <div className="flex items-center justify-center h-10 gap-3 2xl:gap-5 flex-wrap" style={{ overflow: 'visible' }}>
          <button onClick={handleHomeClick}
            className="text-sm xl:text-base font-semibold text-[#1f3d67] hover:text-[#f5a000] whitespace-nowrap cursor-pointer py-1">
            Home
          </button>
          ...
          <button onClick={() => navigate('/admin')}
            className="flex items-center gap-1 text-sm xl:text-base font-semibold text-[#1f3d67] hover:text-[#f5a000] whitespace-nowrap cursor-pointer py-1">

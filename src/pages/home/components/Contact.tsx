        ...
        <div className="bg-gradient-to-r from-sky-700 to-sky-500 py-14 px-8">
          <div className="max-w-7xl mx-auto text-white">
            ...
            <p className="text-sky-100 mt-2">
              We would love to hear from you - reach out for admissions, enquiries, or general information
            </p>
          </div>
        </div>
              ...
              <div className="mt-4 p-4 bg-sky-50 rounded-lg flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">
                    Nearest railway station: Nagercoil Junction (25 km). Nearest airport: Trivandrum
                    International Airport (45 km). Regular bus services available from Kanyakumari and Nagercoil.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              {submitted ? (
                ...
                <form
                  ...
                  className="bg-white border border-slate-100 rounded-xl shadow-sm p-6 space-y-4"
                >
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        name="subject"
                        required
                        className="w-full border border-slate-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-sky-300 text-slate-600"
                      >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full border border-slate-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-sky-300 resize-none"
                    />
                  </div>
                  <button
                    type="submit"
                ...
                <div key={idx} className="bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100 flex flex-col sm:flex-row hover:shadow-md transition-shadow duration-300">
                  <div className="sm:w-1/3 h-40 sm:h-auto bg-slate-50 flex items-center justify-center overflow-hidden">
                    {member.image ? (
                      ...
                      <i className="ri-user-3-line text-5xl text-slate-300"></i>
                    )}
                  </div>
